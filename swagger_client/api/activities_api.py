...
class ActivitiesApi(object):
    ...
    def create_activity(self, name, type, start_date_local, elapsed_time, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_activity(name, type, start_date_local, elapsed_time, async=True)
        >>> result = thread.get()
    ...
    def create_activity_with_http_info(self, name, type, start_date_local, elapsed_time, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_activity_with_http_info(name, type, start_date_local, elapsed_time, async=True)
        >>> result = thread.get()
    ...
    def get_zones_by_activity_id(self, id, **kwargs):  # noqa: E501
        ...
        Summit Feature. Returns the zones of a given activity.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
